...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AuthorEntriesPlugin.author'
        db.delete_column(u'cmsplugin_authorentriesplugin', 'author_id')

        # Adding M2M table for field authors on 'AuthorEntriesPlugin'
        m2m_table_name = db.shorten_name(u'aldryn_blog_authorentriesplugin_authors')
